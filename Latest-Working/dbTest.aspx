...
<body>
    ...
    <div id="inputFields">
        ...
        <div id="buttonz">
            <asp:Button ID="Button2" runat="server" Text="Add Contact (Working!)" OnClick="addContact_Click" />
            <br />
            <br />
            <asp:Button ID="Button1" runat="server" Text="Test DB Connection (Working)" OnClick="testDB_Click" />
             <br />
            <br />
