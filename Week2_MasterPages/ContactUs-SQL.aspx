<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ContactUs-SQL.aspx.cs" Inherits="ContactUs" %>
...
#contactFormLeft
{
 ...
 <div id="loginWrap">
            <div id="loginBox">
                ...
                <br />   
                    ...
                    <div id="centerFeedback">
                        ...
                        <div id="centerSubmit">
                            <asp:Button ID="submitForm" runat="server" Text="Submit" class="btn btn-primary" OnClick="submit_clickSQL" />
                            <br />
                        ...
                        <asp:Label ID="strResult" runat="server" Text="Record Added:"></asp:Label>
                    </div>
    ...
    <br />
    <br />
    <asp:Button ID="testDB" runat="server" Text="Test DB Connection" class="btn btn-info" OnClick="testDB_Click" />
